        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="text-xs font-semibold px-2 py-1 rounded bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 transition"
            >
              {lang === 'en' ? 'ES' : 'EN'}
            </button>
            ...
            {wallet.address ? (
              ...
              >
                {wallet.connecting ? t('trade.connecting') : t('common.connectWallet')}
              </button>
            )}
