      ...
      <footer className="border-t border-gray-200 dark:border-gray-800 py-8 mt-8 bg-white dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-4">
          ...
          <p className="text-center text-xs text-gray-400">
            {new Date().getFullYear()} Veritas. Powered by Azuro Protocol. All markets resolved by Azuro oracle.
          </p>
          ...
          <p className="text-center text-xs text-gray-400">
            Currently unavailable to users in the United States and United Kingdom pending licensing.
          </p>
        </div>
      </footer>
